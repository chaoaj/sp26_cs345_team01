class MenuScreen extends Screen {
  constructor() {
    super();
    this.wildSlideLogo = loadImage("assets/wild_slide.png");
    this.playButton = loadImage("assets/playbtn.png");
    this.settingsButton = loadImage("assets/settingsbtn.png");
    this.exitButton = loadImage("assets/exitbtn.png");
  }
